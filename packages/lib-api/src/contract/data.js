...
export function decodeData (types: Array<string>, data: ?string, withSignature: boolean): Array<any> {
  const values: Array<any> = Abi.rawDecode(types, Buffer.from(removeHexPrefix(data || '0x').substr(withSignature ? 8 : 0), 'hex'));
